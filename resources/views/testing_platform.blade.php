...
<script type="text/javascript">
    ...
    function addInput(form) {
        ...
        newdiv.innerHTML =
            ...
            '<td><select name="type[]" class="form-control type-cus"><option value="id">Id</option><option value="class">Class</option><option value="name">Name</option><option value="text">Text</option><option value="css">CssSelector</option><option value="Xpath">Xpath</option></select></td><td><input type="text" name="target[]" value="" placeholder="Target" class="form-control target-cus"></td>' +
